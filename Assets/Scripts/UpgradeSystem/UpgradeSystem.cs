...
public static class UpgradeSystem
{
    private static readonly List<UpgradeChoice> all = new List<UpgradeChoice>
    {
        new UpgradeChoice {
            ...
            oneTime= false,
            iconResourcePath = "Upgrades/max_hp_20",
        },
        new UpgradeChoice {
            id = "heal_25",
            title = "Heal +25",
        ...
        new UpgradeChoice {
            ...
            oneTime=false,
            iconResourcePath = "Upgrades/move_speed_10p",
        },
        ...
        new UpgradeChoice {
            ...
            oneTime=false,
            iconResourcePath = "Upgrades/weapon_damage_20p",
        },
        new UpgradeChoice {
            ...
            oneTime=false,
            iconResourcePath = "Upgrades/weapon_firerate_15p",
        },
        ...
        new UpgradeChoice {
            ...
            oneTime=false,
            iconResourcePath = "Upgrades/melee_radius_up",
        },
        new UpgradeChoice {
            id = "melee_angle_up",
            title = "Melee: +20° Arc",
            ...
            oneTime=false,
            iconResourcePath = "Upgrades/melee_angle_up",
        },
        new UpgradeChoice {
            id = "melee_damage_25p",
            ...
            oneTime=false,
            iconResourcePath = "Upgrades/melee_damage_25p",
        },
        ...
        new UpgradeChoice {
            ...
            oneTime=false,
            iconResourcePath = "Upgrades/gun_proj_speed_up",
        },
        new UpgradeChoice {
            id = "gun_pierce_on",
            ...
            oneTime=true,
            iconResourcePath = "Upgrades/gun_pierce_on",
        },
        new UpgradeChoice {
            id = "gun_damage_25p",
            title = "Gun: +25% Damage",
            apply = (ps) => WithWeapon<ProjectileWeapon>(ps, w => w.MulDamage(1.25f)),
            oneTime=false,
            iconResourcePath = "Upgrades/gun_damage_25p",
        },
        ...
        new UpgradeChoice {
            ...
            oneTime=false,
            iconResourcePath = "Upgrades/beam_range_up",
        },
        new UpgradeChoice {
            id = "beam_hits_up",
            ...
            oneTime=false,
            iconResourcePath = "Upgrades/beam_hits_up",
        },
        new UpgradeChoice {
            id = "beam_damage_25p",
